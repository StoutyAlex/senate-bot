...
import { SenateMCSecurityGroup } from './walls-security-group';
import { WallsBundle } from './walls-bundle';
import { NodejsFunction } from '@aws-cdk/aws-lambda-nodejs'

export interface SenateWallsServerProps extends cdk.StackProps {
    rconPasswordArn: string
    rconPassword: string
    mcStatusDiscordHook: string
}

export class SenateWallsServer extends cdk.Stack {
    constructor(scope: cdk.App, id: string, props: SenateWallsServerProps) {
        super(scope, id, props)

        const buildName = (name: string) => `senate-minecraft-${name}-walls`
        ...
        const bundle = new WallsBundle(this, 'bundle', {
            serverSecurityGroup,
